...
elgg.tinymce.init = function() {
	...
	tinyMCE.init({
		...
		theme_advanced_buttons1 : "bold,italic,underline,separator,strikethrough,justifyleft,justifycenter,justifyright,forecolor,bullist,numlist,indent,outdent,undo,redo,link,unlink,anchor,image,blockquote,code,pastetext,pasteword,more,fullscreen",
